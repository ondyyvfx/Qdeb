    ...
    <section className="my-24 mx-19">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {debateClubs.map((club, index) => (
          <Card key={index} className="bg-primary border-none flex flex-col p-4 gap-4 items-center">
            ...
            <Button className="bg-secondary hover:bg-secondary/20 mt-2 w-full" size="sm">
              Подробнее
            </Button>
          </Card>
        ))}

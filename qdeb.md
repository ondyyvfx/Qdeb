Перед тестом убедись что запущен tabbycat в докере
...
1. Создать раунд со случайными парами

POST localhost:5629/api/tournaments/{tournamentId}/rounds/random
...
{
  "teamIds": [1, 2, 3, 4],
  "motion": "This house believes AI will replace judges",
  "syncToTabbycat": true
}
```
...
2. Создать пустой раунд

POST localhost:5629/api/tournaments/{tournamentId}/rounds/empty

Query Params:
syncToTabbycat — boolean (default = false)
...
POST localhost:5629/api/tournaments/{tournamentId}/feedback
...
```json
{
  ...
  "sourceJudgeId": null,
  "score": 4,
  "comment": "Judge was fair and clear in explanations.",
  "answers": {
    "clarity": "5",
    "fairness": "4",
    "bias": "no",
    "notes": "Very constructive feedback"
  }
}
```

Query Params:
syncToTabbycat — boolean (default = true)
...
-"SourceType TEAM requires sourceTeamId"
-"SourceType JUDGE requires sourceJudgeId"

401 Unauthorized — нет токена или он недействителен

403 Forbidden — пользователь не имеет права отправлять фидбек

3. Получить список всех турниров

GET localhost:5629/api/tournaments/getAll

Описание:
Возвращает список всех турниров. Доступно без авторизации.
...
[
  {
    ...
    "shortName": "AITU25",
    "slug": "aitu-open-2025",
    "photoUrl": "/files/tournaments/2f4e8b5d.png",
    "organizerName": "AITU Debate Club",
    "organizerContacts": "info@aitu.kz",
    "description": "National-level debate tournament.",
    ...
    "tabbycatId": 101,
    "tabbycatUrl": "http://localhost:8080/tab/tournaments/101/",
    "createdAt": "2025-10-06T10:35:21.512Z",
    "updatedAt": "2025-10-06T10:35:21.512Z"
  }
]
```
...
500 Internal Server Error — ошибка при получении данных из базы.

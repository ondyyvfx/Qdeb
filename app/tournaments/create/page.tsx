                        ...
                        <div className="mb-8">
                            <div className="bg-gradient-to-r from-primary/20 to-accent/20 rounded-2xl p-8 border border-white/10">
                                ...
                                <p className="text-lg text-gray-400 font-medium">
                                    Заполните форму ниже для публикации нового
                                    турнира
                                </p>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <Card className="bg-white/5 border-white/20 shadow-xl hover:shadow-2xl transition-shadow duration-300">
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-gray-400">
                                        Настройте поля, которые заполнят команды
                                        при подаче заявки.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    {registrationFields.length === 0 ? (
                                        <p className="text-sm text-gray-300">
                                            Поля формы пока не выбраны. Откройте
                                            конструктор, чтобы создать шаблон.
                                        </p>
                                    ) : (
                                    ...
                                    <div className="flex flex-wrap items-center justify-between gap-3">
                                        <p className="text-xs text-gray-400">
                                            Шаблон хранится в браузере. После
                                            создания турнира поля будут включены
                                            в заявку.
                                        </p>
                                        <div className="flex flex-wrap gap-2">
                                            ...
                                            <Button
                                                ...
                                                variant="ghost"
                                                onClick={
                                                    handleRefreshRegistrationFields
                                                }
                                            >
                                                Обновить
                                            </Button>
                            ...
                            <Card className="bg-white/5 border-white/20 shadow-xl hover:shadow-2xl transition-shadow duration-300">
                                <CardHeader>
                                    ...
                                    <CardDescription className="text-gray-400">
                                        Загрузите изображение для турнира
                                        (опционально)
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
